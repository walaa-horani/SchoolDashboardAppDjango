    ...
    <div className='max-w-7xl mx-auto p-5 mt-16'>
        ...
        {loading ?(
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
             ...
             <div onClick={()=> navigate(`/teachers/${teacher.id}`)} className='bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition'>
             <img className='w-full h-auto object-cover' src={teacher?.image}/>
