    ...
    <div className='max-w-7xl mx-auto p-5 mt-16'>
        ...
        {loading ?(
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
             ...
             <img className='w-full h-48 object-cover' src={testimonial?.image}/>

              <div className='p-4'>
              
                <h2 className='text-[#b04ba2] font-bold text-[18px]'>{testimonial?.title}</h2>

             <p className='mt-2'>Teacher: {testimonial?.teacher?.name}</p>   
            
            <p className='text-gray-500 mb-2'>{testimonial?.description}</p>
