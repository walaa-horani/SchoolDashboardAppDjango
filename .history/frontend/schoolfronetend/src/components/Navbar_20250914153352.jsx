  ...
  return (
   ...
   <nav className="relative h-[70px] flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 bg-white text-gray-900 transition-all shadow">
    ...
    <div className='flex items-center gap-4'>
         ...
         <button  onClick={() => navigate("/login")} className="hidden md:block  bg-white hover:bg-gray-50 border border-gray-300  px-9 py-2 rounded-full active:scale-95 transition-all">Login</button>

       <button  onClick={() => navigate("/register")} className="hidden md:block  bg-white hover:bg-gray-50 border border-gray-300  px-9 py-2 rounded-full active:scale-95 transition-all">Register</button>
            </div>
