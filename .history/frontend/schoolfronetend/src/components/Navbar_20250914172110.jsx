...
function Navbar() {
  ...
  {!role ? (   // ما في تسجيل دخول
    <>
      <button onClick={() => navigate("/login")} className="hidden md:block ...">Login</button>
      <button onClick={() => navigate("/register")} className="hidden md:block ...">Register</button>
    </>
  ) : (
    <>
      {role === "student" && (
      ...
      {/* الزائر أو الطالب → يطلعلو Logout */}
      <button
